...
import { GOOGLE_CALLBACK_URL,FRONTEND_URL } from 'app-config/config.json';
...
export class AuthController {
  ...
  @ApiResponse({ status: 302, description: 'Chuyển hướng về frontend với token' })
  ...
  changePassword(@CurrentUser() currentUser, @Body() data: ChangePasswordDTO) {
    const userId = currentUser.userId;
